...
const CVButton2 = () => {
  return (
    <Link
      ...
      className="whitespace-nowrap cursor-pointer flex xl:hidden w-full h-10 mt-2 justify-center"
    >
      <button
        type="submit"
        className="font-medium cursor-pointer flex justify-center gap-2 items-center w-full shadow-xl text-lg text-white bg-black backdrop-blur-md lg:font-semibold relative z-10 px-4 py-2 overflow-hidden border-2 border-gray-50 rounded-full group"
      >
